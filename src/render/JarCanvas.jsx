...
import { spawnBug } from "../sim/creatures.js";
    ...
    const stop = startLoop({
      ...
      onRender: () =>
        drawJar(ctx, {
          ...
          t: performance.now() / 1000,        // drives the wobble, blinks and sparkles
        }),
    });
    return stop;
  }, [world]);
  ...
  return (
    <canvas
      ...
      onClick={(e) => {
        ...
        if (tool === "water") world.addWater(c);
        else if (tool === "bug") spawnBug(world, c);
